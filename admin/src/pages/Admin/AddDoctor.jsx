    ...
    <form onSubmit={onSubmitHandler} className='m-5 w-full'>
      ...
      <div className='bg-white px-8 py-8 border border-gray-200 rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
        ...
        <div>
          ...
          <textarea onChange={(e) => setAbout(e.target.value)} value={about} className='w-full border-gray-200 px-4 pt-2 border rounded' placeholder='write about doctor' rows={5} required />
        </div>

        <button type='submit' className='bg-primary px-10 py-3 mt-4 text-white rounded cursor-pointer'>Add Doctor</button>
      </div>
    </form >
  )
}
