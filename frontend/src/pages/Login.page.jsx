            ...
            <div className='flex flex-col gap-3 m-auto items-start p-8 min-w-[340px] sm:min-w-96 rounded-xl text-zinc-600 text-sm shadow-lg'>
                ...
                <p>Please {state === 'Sign Up' ? "sign up" : "log in"} to book appointment</p>
                {
                    ...
                    && <div className='w-full'>
                        <p>Full Name</p>
                        <input className='border border-zinc-300 rounded w-full p-2 mt-1' type="text" onChange={(e) => setUserName(e.target.value)} value={userName} />
                    </div>
                }
                <div className='w-full'>
                    <p>Email</p>
                ...
                <button className='bg-[var(--color-primary)] text-white w-full py-2 rounded-md text-base cursor-pointer'>{state === 'Sign Up' ? "Create Account" : "Login"}</button>
                {
                    state === 'Sign Up'
