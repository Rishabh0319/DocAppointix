    ...
    <div>
      ...
      <div className='my-10 flex flex-col justify-center md:flex-row gap-10 mb-28 text-sm'>
        ...
        <div className='flex flex-col justify-center items-start gap-6'>
          ...
          <p className='text-gray-500'>Tel: (91) 9140279798 <br />Email: greatstackdev@gmail.com</p>
          <p className='font-semibold text-lg text-gray-600'>Careers at DocAppointix</p>
